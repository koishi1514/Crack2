...
from nets.crackformerII import crackformerII
import os
netName = "crackformer"
valid_log_dir = "./log/" + netName
best_model_dir = "./output/" + netName + "/"
image_format = "jpg"
lable_format = "bmp"
lable_format="png"
...
# pretrain_dir="output/crack260.pth"
pretrain_dir="output/crack315.pth"
pretrain_dir='output/crack537.pth'
