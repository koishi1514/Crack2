...
parser.add_argument('--loss_trade_off', type=tuple,
                    default=(0.3, 0.7), help='model_name')
# alpha and beta in loss function, (alpha, beta)
...
# lr 0.01 for deepcrack, 0.001 for cfd
