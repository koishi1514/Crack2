...
class Effi_UNet(nn.Module):
    ...
    Args:
        encoder_name: name of classification output (without last dense layers) used as feature
            extractor to build segmentation output.
        ...
        decoder_attention_type: attention module used in decoder of the output
            One of [``None``, ``scse``]
        in_channels: number of input channels for output, default is 3.
        ...
        aux_params: if specified output will have additional classification auxiliary output
    ...
    def forward(self, x):
        """Sequentially pass `x` trough output`s encoder, decoder and heads"""
