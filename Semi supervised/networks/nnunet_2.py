...
from networks.wavelet_diy import Haar_CrossAttention, HaarWavelet, HaarWaveletTransform
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        for d in range(num_pool):
            ...
            if not self.convolutional_pooling:
                ...
                self.td.append(HaarWavelet(output_features))
...
# output = initialize_network(threeD=True)
# out = output(input_var)
# print(out.size())